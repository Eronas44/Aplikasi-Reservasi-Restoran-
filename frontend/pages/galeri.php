  ...
  <div id="galeri-grid" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
    ...
    <div class="galeri-item utama bg-white p-3 rounded-2xl border border-[#eadfd4] shadow-sm hover:shadow-md transition">
      <div class="overflow-hidden rounded-xl h-64 border border-[#eadfd4]">
        <img src="assets/images/area_privat/areaprivat1.jpg" alt="Ruangan Utama 1" class="w-full h-full object-cover hover:scale-105 transition duration-500">
      </div>
      <div class="p-3">
    ...
    <div class="galeri-item privat bg-white p-3 rounded-2xl border border-[#eadfd4] shadow-sm hover:shadow-md transition">
      <div class="overflow-hidden rounded-xl h-64 border border-[#eadfd4]">
        <img src="assets/images/area_privat/areaprivat2.jpg" alt="Area Privat 2" class="w-full h-full object-cover hover:scale-105 transition duration-500">
      </div>
      <div class="p-3">
    ...
    <div class="galeri-item malam bg-white p-3 rounded-2xl border border-[#eadfd4] shadow-sm hover:shadow-md transition">
      <div class="overflow-hidden rounded-xl h-64 border border-[#eadfd4]">
        <img src="assets/images/suasana_malam/suasanamalam3.jpg" alt="Suasana Malam 3" class="w-full h-full object-cover hover:scale-105 transition duration-500">
      </div>
      <div class="p-3">
    ...
    <div class="galeri-item makanan bg-white p-3 rounded-2xl border border-[#eadfd4] shadow-sm hover:shadow-md transition">
      <div class="overflow-hidden rounded-xl h-64 border border-[#eadfd4]">
        <img src="assets/images/slide_makanan/makanan 4.jpg" alt="Sajian Kuliner 4" class="w-full h-full object-cover hover:scale-105 transition duration-500">
      </div>
      <div class="p-3">
    ...
    <div class="galeri-item indoroutdor bg-white p-3 rounded-2xl border border-[#eadfd4] shadow-sm hover:shadow-md transition">
      <div class="overflow-hidden rounded-xl h-64 border border-[#eadfd4]">
        <img src="assets/images/indoroutdor/outdor.jpg" alt="Indoor / Outdoor 1" class="w-full h-full object-cover hover:scale-105 transition duration-500">
      </div>
      <div class="p-3">
