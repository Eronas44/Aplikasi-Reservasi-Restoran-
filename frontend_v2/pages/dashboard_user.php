  ...
  <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
    ...
    <div class="lg:col-span-1 space-y-3">
      <div class="bg-white/80 border border-[#eadfd4] rounded-2xl p-4 shadow-sm space-y-2">
        ...
        <a href="<?= route('reservasi') ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl text-[#5e392e] hover:bg-[#efebe4] font-medium text-sm transition">
    ...
    <div class="lg:col-span-3">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <a href="<?= route('detail_restoran', ['resto' => 'A']) ?>" class="bg-white/80 border border-[#eadfd4] rounded-3xl p-5 shadow-sm flex flex-col hover:border-[#8a5d49] transition group">
          <div class="w-full h-48 rounded-2xl overflow-hidden mb-4 border border-[#eadfd4] relative carousel-container" data-images='["assets/images/Resto/KidsCornerRestoA.jpg", "assets/images/Resto/RestoA.jpg", "assets/images/Resto/ViewRestoA.jpg", "assets/images/Resto/LiveCookingRestoA.jpg"]'>
            <img src="assets/images/Resto/KidsCornerRestoA.jpg" alt="Restoran A" class="w-full h-full object-cover transition-opacity duration-700 carousel-img">
          </div>
        ...
        <a href="<?= route('detail_restoran', ['resto' => 'B']) ?>" class="bg-white/80 border border-[#eadfd4] rounded-3xl p-5 shadow-sm flex flex-col hover:border-[#8a5d49] transition group">
          <div class="w-full h-48 rounded-2xl overflow-hidden mb-4 border border-[#eadfd4] relative carousel-container" data-images='["assets/images/Resto/ViewRestoB.jpg", "assets/images/Resto/DjRestoB.jpg", "assets/images/Resto/GamingRestoB.jpg", "assets/images/Resto/BarRestoB.png"]'>
            <img src="assets/images/Resto/ViewRestoB.jpg" alt="Restoran B" class="w-full h-full object-cover transition-opacity duration-700 carousel-img">
          </div>
          <div class="flex items-center justify-between mt-auto">
        ...
        <a href="<?= route('detail_restoran', ['resto' => 'C']) ?>" class="bg-white/80 border border-[#eadfd4] rounded-3xl p-5 shadow-sm flex flex-col hover:border-[#8a5d49] transition group">
          <div class="w-full h-48 rounded-2xl overflow-hidden mb-4 border border-[#eadfd4] relative carousel-container" data-images='["assets/images/Resto/ViewRestoC.jpg", "assets/images/Resto/birdparkRestoC.jpg", "assets/images/Resto/dapurTerbukaRestoC.jpg", "assets/images/Resto/gamelanrestoC.jpg"]'>
            <img src="assets/images/Resto/ViewRestoC.jpg" alt="Restoran C" class="w-full h-full object-cover transition-opacity duration-700 carousel-img">
          </div>
          <div class="flex items-center justify-between mt-auto">
        ...
        <a href="<?= route('detail_restoran', ['resto' => 'D']) ?>" class="bg-white/80 border border-[#eadfd4] rounded-3xl p-5 shadow-sm flex flex-col hover:border-[#8a5d49] transition group">
          <div class="w-full h-48 rounded-2xl overflow-hidden mb-4 border border-[#eadfd4] relative carousel-container" data-images='["assets/images/Resto/KapsulD.jpg", "assets/images/Resto/tapayakirestoD.jpg", "assets/images/Resto/ViewRestoD.jpg"]'>
            <img src="assets/images/Resto/ViewRestoD.jpg" alt="Restoran D" class="w-full h-full object-cover transition-opacity duration-700 carousel-img">
          </div>
          <div class="flex items-center justify-between mt-auto">
