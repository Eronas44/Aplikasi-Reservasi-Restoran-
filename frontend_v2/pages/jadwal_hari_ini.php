...
if (empty($jadwal)) {
    $demo = [
        ['reservation_time' => '12:00', 'user' => ['name' => 'Budi Santoso', 'phone_number' => '0812-3456-7890'], 'booking_code' => 'KB-000001', 'number_of_guest' => 4, 'table' => ['table_number' => 'T12'], 'status' => 'confirmed'],
        ['reservation_time' => '12:30', 'user' => ['name' => 'Siti Rahma', 'phone_number' => '0813-2222-3333'], 'booking_code' => 'KB-000002', 'number_of_guest' => 2, 'table' => ['table_number' => 'T05'], 'status' => 'confirmed'],
        ['reservation_time' => '13:00', 'user' => ['name' => 'Andi Wijaya', 'phone_number' => '0814-5555-6666'], 'booking_code' => 'KB-000003', 'number_of_guest' => 6, 'table' => ['table_number' => 'T08'], 'status' => 'pending'],
        ['reservation_time' => '18:00', 'user' => ['name' => 'Rina Kartika', 'phone_number' => '0815-7777-8888'], 'booking_code' => 'KB-000005', 'number_of_guest' => 8, 'table' => ['table_number' => 'T11'], 'status' => 'confirmed'],
        ['reservation_time' => '19:00', 'user' => ['name' => 'Bima Pratama', 'phone_number' => '0816-9999-0000'], 'booking_code' => 'KB-000007', 'number_of_guest' => 5, 'table' => ['table_number' => 'T10'], 'status' => 'confirmed'],
    ];
    foreach ($demo as $d) {
        $d['reservation_id'] = 0;
        $jadwal[] = $d;
